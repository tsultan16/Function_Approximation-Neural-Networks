...
used to build a neural nwteork/deep learning models and also contains a 'Trainer' class which can
be used to train datasets and compute predictions. 

(Activation functions: Sigmoid, Tanh)
(Loss functions: Mean-Squared, Softmax cross-entropy) 